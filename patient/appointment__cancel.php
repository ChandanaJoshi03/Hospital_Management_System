	 ...
	 <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-danger">
			...
			<?php $appointment_id=$_REQUEST['appointment_id']; 
			
			$patient_id=$_REQUEST['patient_id'];
			?>

<form name="form1" id="formID" method="post" action="appointment__cancel_insert.php">
<input type="hidden" value="<?PHP echo $appointment_id; ?>" name="appointment_id" >
  <table width="386" height="301" border="0" align="center">
   
    <tr>
      <td width="176">Patient  </td>
	 ...
	 echo  $sql="select * from p_details where contact_no='$username'";
	  ...
	  {
	  ?>
        <option value="<?php echo $row['patient_id'];?>" <?php if($patient_id==$row['patient_id']) {  ?> selected <?php } ?>	> <?php echo $row['patient_full_name'];?></option>
        <?php
	  }
	  ?>
      </select></td>
    ...
    <tr>
      ...
      <td><textarea name="description" class="validate[required,custom[onlyLetter]] form-control" id="description"></textarea></td>
    </tr>
    <tr>
	  ...
	  $myCalendar = new tc_calendar("dat", true, true);
