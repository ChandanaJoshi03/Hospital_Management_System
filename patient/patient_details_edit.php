...
<input type="hidden" name="patient_id" value="<?php echo $row['patient_id'];?>">
  ...
  <table width="503" height="642" border="0" align="center">
    ...
    <tr>
      ...
      <td width="275"><input name="p_full_name" type="text" id="p_full_name" placeholder="Enter Your Full Nme" value="<?php echo $row ['patient_full_name'];?>"  class="validate[required,custom[onlyLetter]] form-control"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="gender" type="radio" <?php if($gender=='Male') {?> checked <?php } ?> value="Male"> 
      Male 
      <input name="gender" type="radio" <?php if($gender=='Female') {?> checked <?php } ?> value="Female"> 
      Female </td>
    </tr>
    <tr>
      <td>Blood Group </td>
    ...
    <tr>
      <td>Photo</td>
      <td>        <img src="../photo/<?php echo $row ['photo'];?>" width="100" height="100"> <br /><!-- <input name="photo" type="file" id="photo"> --></td>
    </tr>
    <tr>
