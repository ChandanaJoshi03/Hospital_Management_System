...
<tbody> 
  ...
  $sql="select * from  appointment ap, p_details pd where ap.patient_id=pd.patient_id";
  ...
  <tr>
    ...
    <td><a href="appointment__accept.php?appointment_id=<?php echo $row['appointment_id']; ?>&contact_no=<?php echo $row['contact_no']; ?>&patient_full_name=<?php echo $row['patient_full_name']; ?>" class="btn btn-info">Accept</a> <a href="appointment__reject.php?appointment_id=<?php echo $row['appointment_id']; ?>" class="btn btn-danger">Reject</a></td>
    ...
    <td><a href="appointment_form_delete.php?appointment_id=<?php echo $row['appointment_id']; ?>" onClick="return confirm('You want To Delete');" title="Delete"><img src="icons/delete.jpg" width="50" height="50"></a></td>
  </tr>
  <?php
  }
  ?>
