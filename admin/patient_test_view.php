...
<thead>
  <tr>
	...
	<th width="130">Test Rate</th>
    <th width="130">Test Status</th>
	<th width="130">Bill Generaaator</th>
	<th width="130">View Bill</th>
    <th width="82">Edit</th>
...
<tbody> 
  ...
  $sql="select * from   patient_test ap, p_details pd ,test_details td where ap.patient_id=pd.patient_id and ap.test_details_id=td.test_details_id";
  ...
  <tr>
	...
	<th width="130"><a href="patient_test_generaaator.php?patient_test_id=<?php echo $row['patient_test_id']; ?>" class="btn btn-warning">Bill Generaaator</a></th>
	 <td><a href="patient_test_view_bill.php?patient_test_id=<?php echo $row['patient_test_id']; ?>"  class="btn btn-info">View Bill</a></td>
...
<p class="btn btn-primary"> Total Amount :<?php echo $tal; ?> </p>
 </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
