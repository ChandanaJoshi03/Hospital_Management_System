...
function printDiv(divName) {
 ...
 <?php
  ...
  $sql="select * from   patient_test ap, p_details pd ,test_details td where ap.patient_id=pd.patient_id and ap.test_details_id=td.test_details_id  	and ap.patient_test_id='$patient_test_id'";
